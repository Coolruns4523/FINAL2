...
public class CategoryController {
    ...
    public String showIndex(Model model, HttpServletRequest request)
    {
       ...
       // model.addAttribute("post",journalRepository.findAllByArtistNameIgnoreCase(theName));
        return "index";
    }
    @PostMapping("/savecategories")
    public String saveCategories(@Valid @ModelAttribute("post") Journal journal, BindingResult result)
    {
        if(result.hasErrors())
        {
            return "index";
        ...
        return "redirect:/?name="+journal.getArtistName();
    }
